...
describe("selectOutputMode", () => {
	...
	describe("piped stdin", () => {
		it("should use plain text mode when stdin was piped (echo x | shuttle)", () => {
			const result = selectOutputMode({
				stdoutIsTTY: true,
		...
		it("should use plain text mode when stdin was piped but empty (echo '' | shuttle 'prompt')", () => {
			const result = selectOutputMode({
				stdoutIsTTY: true,
				stdinIsTTY: false,
	...
	describe("real-world scenarios", () => {
		it("shuttle (no args, interactive terminal)", () => {
			const result = selectOutputMode({
				stdoutIsTTY: true,
				stdinIsTTY: true,
				stdinWasPiped: false,
