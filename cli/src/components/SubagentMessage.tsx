			...
			return (
				<Box flexDirection="column" marginBottom={1} width="100%">
					<DotRow color={toolColor}>
						<Text color={toolColor}>Shuttle wants to run subagents:</Text>
					</DotRow>
				</Box>
			)
		}
		...
		return (
			<Box flexDirection="column" marginBottom={1} width="100%">
				<DotRow color={toolColor} flashing={partial === true && isStreaming}>
					<Text color={toolColor}>{singular ? "Shuttle wants to run a subagent:" : "Shuttle wants to run subagents:"}</Text>
				</DotRow>
			...
			<Box flexDirection="column" marginBottom={1} width="100%">
				<DotRow color={toolColor} flashing={partial === true && isStreaming}>
					<Text color={toolColor}>
						{items.length === 1 ? "Shuttle is running a subagent:" : "Shuttle is running subagents:"}
					</Text>
				</DotRow>
				<Box flexDirection="column" marginLeft={2} width="100%">
