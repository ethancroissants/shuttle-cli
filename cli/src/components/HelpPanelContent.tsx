 ...
 * Explains ShuttleAI CLI features and links to documentation
 */
	...
	return (
		<Panel label="Help">
			<Box flexDirection="column" gap={1}>
				<Text>Shuttle can edit files, run terminal commands, use the browser, and more with your permission.</Text>
				...
				<Box flexDirection="column">
					...
					<Text>
						...
						<Text color={COLORS.primaryBlue}>Act</Text> mode when you're ready for Shuttle to edit files and run
				...
				<Box flexDirection="column">
					...
					<Text>
						{"  "}
						<Text color="white">/q</Text> - Quit Shuttle
					</Text>
				</Box>
