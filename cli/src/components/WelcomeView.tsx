 ...
 * Shows an interactive prompt when user starts shuttle without a command
...
// ASCII art ShuttleAI logo
const CLINE_LOGO = [
	"   ____  _           _   _   _       _    ___ ",
	"  / ___|| |__  _   _| |_| |_| | ___ / \\  |_ _|",
	"  \\___ \\| '_ \\| | | | __| __| |/ _ \\ _ \\  | | ",
	"   ___) | | | | |_| | |_| |_| |  __/ ___ \\ | | ",
	"  |____/|_| |_|\\__,_|\\__|\\__|_|\\___|_/  \\_\\___|",
]
